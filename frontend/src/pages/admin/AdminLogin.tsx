...
export function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("स्वागत है प्रशासक! (Welcome Administrator!)");
      navigate("/admin");
    } catch (error: any) {
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col md:block">
              <p className="text-xl md:text-2xl font-semibold text-gray-700">व्यवस्थापक पोर्टल</p>
              <p className="text-lg md:text-xl text-gray-600">Administrator Portal</p>
            </div>
            ...
            <div className="hidden md:block">
              <div className="mt-8 p-6 bg-gradient-to-br from-orange-50 to-yellow-50 rounded-lg border-2 border-[#FFD700]/50 relative overflow-hidden">
                ...
                <p className="text-sm font-semibold text-gray-700 mb-2">
                  👑 सर्वोच्च प्रशासक प्रवेश
                </p>
                <p className="text-xs text-gray-600">
                  Maximum Security - System Administrator Access Only. All activities are logged and monitored.
                </p>
              </div>
          ...
          <Card className="shadow-2xl border-2 border-[#FFD700]/30 relative overflow-hidden bg-gradient-to-br from-white to-orange-50/30">
            ...
            <CardHeader className="space-y-1 relative z-10 pt-6">
              ...
              <CardDescription className="text-center">
                High-Level Security Administrator Access
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="adminId" className="flex items-center gap-2">
                    ...
                    व्यवस्थापक आईडी या ईमेल / Admin ID or Email *
                  </Label>
                  <Input
                    id="adminId"
                    type="text"
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Enter your unique administrator secret key
                  </p>
                </div>
                ...
                >
                  ...
                  {loading ? "प्रवेश हो रहा है..." : "सुरक्षित प्रवेश / Secure Access"}
                </Button>
                ...
                >
                  ...
                  बायोमेट्रिक प्रमाणीकरण / Biometric Auth
                </Button>
              </form>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-700 mb-1">
                      अधिकतम सुरक्षा | Maximum Security Level
                    </p>
                    <p className="text-xs text-gray-600">
                      All admin activities are logged, encrypted, and audited. Unauthorized access attempts will be reported.
                    </p>
                  </div>
                </div>
              </div>
