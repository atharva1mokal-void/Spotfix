...
export function CitizenLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.message || "लॉगिन विफल (Login failed)");
    }
  };
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col md:block">
              <p className="text-xl md:text-2xl font-semibold text-gray-700">नागरिक पोर्टल</p>
              <p className="text-lg md:text-xl text-gray-600">Citizen Portal</p>
            </div>
          ...
          <Card className="shadow-2xl border-2 border-[#FF9933]/20 relative overflow-hidden">
            ...
            <CardHeader className="space-y-1 relative z-10">
              <CardTitle className="text-2xl text-center">नागरिक लॉगिन</CardTitle>
            ...
            <CardContent className="relative z-10">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  OTP से लॉगिन करें / Login with OTP
                </Button>
              </form>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-orange-50 to-green-50 rounded-lg border border-[#FF9933]/20">
                <p className="text-xs text-center text-gray-600">
                  🇮🇳 सुरक्षित और विश्वसनीय | Secure & Trusted Platform
                </p>
              </div>
            </CardContent>
          </Card>
