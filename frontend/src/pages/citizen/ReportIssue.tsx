              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      id="location"
                      placeholder={locationLoading ? "Detecting GPS location..." : "Your location coordinates"}
                  ...
                  {locationError ? (
                    ...
                    <p className="text-xs text-gray-500">
                      GPS coordinates are automatically captured for accurate reporting. Required.
                    </p>
                  )}
                </div>
